...
def create_word_report(
    ...
    word_path = (
        ...
        f"docs/word/"
        f"{safe_name}_documentation.docx"
    )
    ...
    title = document.add_heading(
        ...
        f"ADF Enterprise Documentation - {pipeline_name}",
...
"""
    ...
    document.add_heading(
        ...
        "Dataset Lineage Flow",

        level=2
    )

    lineage_flow = build_lineage_flow(
        lineage
    )
